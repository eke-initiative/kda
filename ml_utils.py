...
from mlsmote import MLSMOTE_iterative, MLSMOTE, get_irlb
import pandas as pd
...
def generalise_annotation_set(annotation_set, hierarchy, domain_to_id, id_to_domain):
    annotation_set_new = set(annotation_set)
    for ii in annotation_set:
    ...
    return [a for a in annotation_set_new]
